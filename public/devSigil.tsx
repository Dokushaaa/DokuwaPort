...
const DevSigil = (props: Props) => {
	const classColor = props.coloration;
	const adjustedHeight = props.height;
	const adjustedWidth = props.width;
	return (
		<>
			<svg
				className={`${classColor} p-0 m-0 rounded-md`}
